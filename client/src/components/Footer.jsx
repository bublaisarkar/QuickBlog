      ...
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        <div>
          ...
          <p className="max-w-[410px] mt-6">
            ...
            iste esse impedit fuga ullam vero commodi ducimus? Officiis dicta
            vero autem officia dignissimos molestiae consequuntur. Numquam
            voluptatem illum voluptatum.
          </p>
        </div>
